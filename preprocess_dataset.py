...
data_file_positive = 'positive-add_text.jsonl'
data_file_can_not_test = 'can_not_test-add_text.jsonl'
data_file_cure_and_prevention = 'cure_and_prevention-add_text.jsonl'
data_file_death = 'death-add_text.jsonl'
data_file_negative = 'negative-add_text.jsonl'
